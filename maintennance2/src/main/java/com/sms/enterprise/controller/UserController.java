...
public class UserController {
	 ...
	 * ModelAndView allUsers() { ModelAndView modelAndView = new ModelAndView();
	 * //POINT=7
	 * http://stackoverflow.com/questions/22364886/neither-bindingresult-nor-plain-
	 * target-object-for-bean-available-as-request-attr
	 * modelAndView.addObject("users", userService.findAll());
	 * modelAndView.addObject("mode", "MODE_ALL"); modelAndView.addObject("auth",
	 * getUser()); modelAndView.addObject("control", getUser().getRole().getRole());
	 * modelAndView.setViewName("user"); return modelAndView; }
	 * 
	 */	
