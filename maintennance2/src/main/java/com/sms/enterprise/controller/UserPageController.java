...
public class UserPageController {
	...
	public ModelAndView showProfile() {
		...
		User control =(User) userService.findUserByEmail(auth.getName());
	...
	public ModelAndView saveProfile(@Valid User user,UserBean userbean, BindingResult bindingResult) {
	...
	public ModelAndView confirmPasswordChange(@Valid User user,UserBean userbean, BindingResult bindingResult) {
		ModelAndView modelAndView = new ModelAndView();
