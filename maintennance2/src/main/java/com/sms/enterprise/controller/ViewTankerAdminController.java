...
@Controller
@RequestMapping("/tankeradmin/ViewOrders")
public class ViewTankerAdminController {
	...
	public ModelAndView newUserTask(Model model,Pageable pageable,@Param("keyword") String keyword) {
		...
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/view");
		model.addAttribute("orders", page.getContent());
        model.addAttribute("page", page);
		modelAndView.setViewName("tankeradminviewuserorder");
		//System.out.println(orderService.findAll());
		return modelAndView;
	}
	
	@RequestMapping(value = "/searchrequestorder", method = RequestMethod.POST)
	public ModelAndView searchRequestOrder(@RequestParam("theSearchName") String theSearchName,Model model,Pageable pageable) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.addObject("order", new Order());
		modelAndView.addObject("users", userService.findAll());
		modelAndView.addObject("auth", getUser());
		modelAndView.addObject("control", getUser().getRole().getRole());
		List<Order> orderListApprove=orderService.searchRequestOrder(theSearchName);
		int start = (int) pageable.getOffset();
		...
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/searchrequestorder");
		model.addAttribute("orders", page.getContent());
        model.addAttribute("page", page);
		modelAndView.setViewName("tankeradminviewuserorder");
	    //System.out.println(orderService.findAll());
	...
	@RequestMapping(value = "/searchrequestorder", method = RequestMethod.GET)
	public ModelAndView searchRequestOrderGet(Model model,Pageable pageable) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.addObject("order", new Order());
		modelAndView.addObject("users", userService.findAll());
		modelAndView.addObject("auth", getUser());
		modelAndView.addObject("control", getUser().getRole().getRole());
		List<Order> orderListApprove=orderService.findAll();
		int start = (int) pageable.getOffset();
		int end = (start + pageable.getPageSize()) > orderListApprove.size() ? orderListApprove.size() : (start + pageable.getPageSize());
		Page<Order> pages = new PageImpl<Order>(orderListApprove.subList(start, end), pageable, orderListApprove.size());
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/searchrequestorder");
	...
	public ModelAndView ApproveOrder(@PathVariable int id) {
		...
		modelAndView.setViewName("redirect:/tankeradmin/ViewOrders/view");
		//System.out.println(orderService.findAll());
		return modelAndView;
	}
	...
	public ModelAndView viewApproveOrder(Model model,Pageable pageable) {
		...
		int end = (start + pageable.getPageSize()) > orderListApprove.size() ? orderListApprove.size() : (start + pageable.getPageSize());
		Page<Order> pages = new PageImpl<Order>(orderListApprove.subList(start, end), pageable, orderListApprove.size());
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/viewapproveorder");
		model.addAttribute("orders", page.getContent());
        model.addAttribute("page", page);
		modelAndView.setViewName("tankeradminviewapproveorders");
	    //System.out.println(orderService.findAll());
		return modelAndView;
	}
	...
	public ModelAndView viewPendingOrder(Model model,Pageable pageable) {
		...
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/viewpendingorder");
		model.addAttribute("orders", page.getContent());
        model.addAttribute("page", page);
		modelAndView.setViewName("tankeradminviewpendingorders");
		//System.out.println(orderService.findAll());
		return modelAndView;
	}
	
	@RequestMapping(value = "/searchpendingorder", method = RequestMethod.POST)
	public ModelAndView searchPendingOrder(@RequestParam("theSearchName") String theSearchName,Model model,Pageable pageable) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.addObject("order", new Order());
		modelAndView.addObject("users", userService.findAll());
		modelAndView.addObject("auth", getUser());
		modelAndView.addObject("control", getUser().getRole().getRole());
		List<Order> orderListApprove=orderService.searchPendingOrder(theSearchName);
		int start = (int) pageable.getOffset();
		int end = (start + pageable.getPageSize()) > orderListApprove.size() ? orderListApprove.size() : (start + pageable.getPageSize());
		Page<Order> pages = new PageImpl<Order>(orderListApprove.subList(start, end), pageable, orderListApprove.size());
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/viewpendingorder");
	...
	public ModelAndView approvePendingOrder(@PathVariable int id) {
		...
		modelAndView.addObject("control", getUser().getRole().getRole());
		modelAndView.addObject("ordersview", orderService.approveOrder(id));
		modelAndView.setViewName("redirect:/tankeradmin/ViewOrders/viewpendingorder");
		//System.out.println(orderService.findAll());
		return modelAndView;
	}
	...
	public ModelAndView viewHomePage(Model model,Pageable pageable) {
		...
		int end = (start + pageable.getPageSize()) > orderList.size() ? orderList.size() : (start + pageable.getPageSize());
		Page<Order> pages = new PageImpl<Order>(orderList.subList(start, end), pageable, orderList.size());
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/page");
		model.addAttribute("orders", page.getContent());
        model.addAttribute("page", page);
	...
	public ModelAndView viewAlertPage(Model model,Pageable pageable) {
		...
		int end = (start + pageable.getPageSize()) > orderList.size() ? orderList.size() : (start + pageable.getPageSize());
		Page<Order> pages = new PageImpl<Order>(orderList.subList(start, end), pageable, orderList.size());
		PageWrapper<Order> page = new PageWrapper<Order>(pages, "/tankeradmin/ViewOrders/alertorder");
		model.addAttribute("orders", page.getContent());
        model.addAttribute("page", page);
		modelAndView.setViewName("tankeradminalertorder");
		return modelAndView;	
	}
	...
	public ModelAndView approveAlertOrder1(@PathVariable int id) {
		...
		modelAndView.addObject("control", getUser().getRole().getRole());
		modelAndView.addObject("ordersview", orderService.approveOrder(id));
		modelAndView.setViewName("redirect:/tankeradmin/ViewOrders/alertorder");
		//System.out.println(orderService.findAll());
		return modelAndView;
	}
